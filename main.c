...
//sleep(30);
 int nb_run = 0;
 int N = 301;
 #pragma omp parallel shared(W_L, W_LII, W_LIII,W_O, b_L, b_LII, b_LIII, b_O, eta, ERROR_OUTPUT, ERROR_LAYERIII, ERROR_LAYERII, ERROR_LAYER, INPUT, LAYER, LAYERII,LAYERIII, OUTPUT)  num_threads(6)
 {
 while(nb_run < N){
